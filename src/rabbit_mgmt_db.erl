...
%% consumers when we hear about any queue or channel going down.
delete_consumers(KeyMatch, #state{tables = Tables}) ->
    Table = orddict:fetch(consumers, Tables),
    ets:match_delete(Table, {KeyMatch, '_'}).
